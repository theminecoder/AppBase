...
public final class AppLoggerAdaptor extends MarkerIgnoringBase implements LocationAwareLogger {
    private static final long serialVersionUID = -8053026990503422791L;
    final transient Logger logger;
    static String SELF = AppLoggerAdaptor.class.getName();
    static String SUPER = MarkerIgnoringBase.class.getName();

    AppLoggerAdaptor(Logger logger) {
        this.logger = logger;
